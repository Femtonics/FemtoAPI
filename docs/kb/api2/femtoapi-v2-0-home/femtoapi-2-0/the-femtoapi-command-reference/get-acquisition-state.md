...
*Note*: Only input channels metadata information are get with this command, the output channel informations and much more regarding used waveforms, patterns, etc. can be get with the  getActiveProtocol() ([Tools](tools.md)) command.
